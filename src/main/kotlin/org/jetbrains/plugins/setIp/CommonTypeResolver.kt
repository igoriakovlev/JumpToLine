...
internal class CommonTypeResolver(private val project: Project) {
    ...
    fun tryGetCommonType(fqName1: String, fqName2: String): String? {
        ...
        val class1 = PsiType.getTypeByName(fqName1, project, projectScope).resolve() ?: return null
        val class2 = PsiType.getTypeByName(fqName2, project, projectScope).resolve() ?: return null
